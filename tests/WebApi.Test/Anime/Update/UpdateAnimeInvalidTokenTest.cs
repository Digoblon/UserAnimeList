...
public class UpdateAnimeInvalidTokenTest : UserAnimeListClassFixture
{
    ...
    public UpdateAnimeInvalidTokenTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
    ...
    public async Task Error_Token_Invalid()
    {
        ...
        var response = await DoPut($"{Method}/{_animeId}",request, token: "tokenInvalid");
    ...
    public async Task Error_Token_With_User_NotFound()
    {
        ...
        var request = RequestAnimeJsonBuilder.Build();
        var response = await DoPut($"{Method}/{_animeId}",request,token: token);
