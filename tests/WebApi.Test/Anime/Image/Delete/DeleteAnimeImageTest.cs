...
public class DeleteAnimeImageTest : UserAnimeListClassFixture
{
    ...
    public DeleteAnimeImageTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
    ...
    public async Task Success()
    {
        ...
        var response = await DoDelete($"{Method}/{_animeId}/image", token);
    ...
    public async Task Error_Anime_Not_Found(string culture)
    {
        ...
        var response = await DoDelete($"{Method}/{Guid.NewGuid()}/image",token,culture);
