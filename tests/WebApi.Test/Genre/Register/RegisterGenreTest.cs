...
public class RegisterGenreTest : UserAnimeListClassFixture
{
    private readonly Guid _id;
    private readonly int _tokenVersion;
    private readonly UserRole _userRole;

    private readonly string method = "genre";

    public RegisterGenreTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
