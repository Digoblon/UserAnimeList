...
public class UpdateUserImageInvalidTokenTest : UserAnimeListClassFixture
{
    private const string METHOD = "user/me/image";
    private readonly Guid _id;
    private readonly UserRole _userRole;
    
    public UpdateUserImageInvalidTokenTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
