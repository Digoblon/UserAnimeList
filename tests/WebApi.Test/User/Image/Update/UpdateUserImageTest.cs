...
namespace WebApi.Test.User.Image.Update;

public class UpdateUserImageTest : UserAnimeListClassFixture
{
    ...
    public async Task Success()
    {
        ...
        var response = await DoPutMultipart(METHOD, request, token);
    ...
    public async Task Error_Empty_Form(string culture)
    {
        ...
        var response = await DoPutMultipart(METHOD, request,token,culture);
