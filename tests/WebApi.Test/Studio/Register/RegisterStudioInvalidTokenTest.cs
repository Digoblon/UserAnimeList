...
public class RegisterStudioInvalidTokenTest : UserAnimeListClassFixture
{
    ...
    public RegisterStudioInvalidTokenTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
