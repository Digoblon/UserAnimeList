...
namespace WebApi.Test.AnimeList.List.ById;

public class ListAnimeListByIdTest : UserAnimeListClassFixture
{
    private const string Method = "animelist/list";
    ...
    public ListAnimeListByIdTest(CustomWebApplicationFactory factory) : base(factory)
    {
        _id = factory.GetId();
    ...
    public async Task Success()
    {
        ...
        var response = await DoGetQuery($"{Method}/{_id}",request,token);
    ...
    public async Task Error_List_Not_Found(string culture)
    {
        ...
        var response = await DoGetQuery($"{Method}/{_id}",request,token,culture);
